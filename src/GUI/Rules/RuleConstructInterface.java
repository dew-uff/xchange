...
public class RuleConstructInterface extends JDialog implements ActionListener{
     ...
     * @param array
     * Array contendo todos os fatos.
     * @return arrayResult
     * Array com os fatos repetidos removidos.
     */
     ...
     * @param facts
     * Um vetor de Strings onde cada índice contém os fatos completos.     
     */
    ...
    private void setPanelTerminal() {
        ...
        * @param exit
        * O que se deseja como saída da regra.
        * @param term1
        * Primeiro termo a ser utilizado.
        * @param operator
        * Operador a ser aplicado.
        * @param term2
        * Segundo termo a ser utilizado.
        * @return newRule
        * Nova regra construída.
        */
     ...
     * @param fact
     * String contendo um fato completo.
     * @return nameFact
     * String contendo o nome de um fato.
     */
