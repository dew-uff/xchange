...
public class RulesModule {
    ...
    /**
     * Adiciona as regras selecionadas em sua respectiva variável recebendo como
     * parametro uma String.
     *
     * @param newRule String com uma das regras selecionadas pelo usuário.
     */
    public void addSelectRules(Rule newRule) {
