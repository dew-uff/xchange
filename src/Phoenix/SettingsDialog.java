...
public class SettingsDialog {
    ...
    private JTextField nameWeightField, valueWeightField, attributeWeightField,
            childrenWeightField;
    private JCheckBox RootIgnoreThresholdBox, automaticAllocationBox, ignoreTrivialBox;
    ...
    private void constructDialog(Window parent) {
        ...
        dialog.getContentPane().add(RootIgnoreThresholdBox);
    ...
    private void updateFields() {
        ...
        boolean nameReqEnabled = RootIgnoreThresholdBox.isSelected();
    ...
    private void constructWidgets() {
        ...
        RootIgnoreThresholdBox = new JCheckBox("Ignore Threshold on Root");
        RootIgnoreThresholdBox.setSelected(SettingsHelper
                .getIgnoreThresholdOnRoot());
        RootIgnoreThresholdBox.addActionListener(new ActionListener() {
        ...
        nameWeightField = new JTextField(Double.toString(SettingsHelper
                .getNameSimilarityWeight()), 5);
        valueWeightField = new JTextField(Double.toString(SettingsHelper
                .getValueSimilarityWeight()), 5);
        attributeWeightField = new JTextField(Double.toString(SettingsHelper
                .getAttributeSimilarityWeight()), 5);
        childrenWeightField = new JTextField(Double.toString(SettingsHelper
    ...
    protected boolean areValuesOk() {
        ...
        boolean nameSimilarityRequired = RootIgnoreThresholdBox.isSelected();
    ...
    protected void saveAllSettings() {
        ...
        SettingsHelper
                .setIgnoreThresholdOnRoot(RootIgnoreThresholdBox.isSelected());
