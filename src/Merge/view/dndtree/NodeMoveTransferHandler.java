 ...
 * 
 * <p>
 * Transfer handler implementation that supports to move a selected tree node within a <code>JTree</code>.
 * </p>
 * 
 ...
 * @author published under the terms and conditions of the GNU General Public License, for details see file gpl.txt in the distribution
...
public class NodeMoveTransferHandler extends TransferHandler {
      ...
      * @return all selected paths in the given tree (or null if the given component is not a tree)
      */
     protected Transferable createTransferable(JComponent c) {
          ...
          if (c instanceof JTree) {
               ...
               if (dragPath != null) {
                    DefaultMutableTreeNode treeNode = (DefaultMutableTreeNode) dragPath.getLastPathComponent();
     ...
     private void addNodes(TreePath currentPath, DefaultTreeModel model,
          ...
          try {
               ...
               for (int i = 0; i < movedPaths.length; i++) {
                    ...
                    XMLEditHandler.getInstance().applyManualMove(moveNode);
     ...
     private void insertNodes(JTree tree, DefaultTreeModel model,
               Transferable data) {
     ...
     /**
      * Returns the type of transfer actions supported by the source. This transfer handler supports moving of tree nodes so it returns
      * MOVE.
      * 
     ...
     public BufferedImage getDragImage(JTree tree) {
          ...
          try {
               if (dragPath != null) {
                    ...
                    JComponent lbl = (JComponent) r.getTreeCellRendererComponent(tree, draggedNode, false, tree.isExpanded(dragPath), nIsLeaf, 0, false);
