 ...
 * 
 * <p>
 * This transferable takes an object as data that is to be transferred. It uses DataFlavor.stringFlavor, which is supported by all objects.
 * This transferable can be used in cases where a special handling in terms of which data flavors are acceptable or which data is
 * transported do not matter.
 * </p>
 * 
